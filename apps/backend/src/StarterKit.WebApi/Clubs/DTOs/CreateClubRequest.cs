...
public sealed class CreateClubRequest
{
    ...
    /// <summary>Optional display name for the club's first season (e.g. "2026 Indoor").</summary>
    [MaxLength(100)]
    public string? SeasonName { get; init; }

    /// <summary>Start date of the club's first season. Onboarding always defines a season explicitly.</summary>
    [Required]
    public DateOnly SeasonStartDate { get; init; }

    /// <summary>End date of the club's first season.</summary>
    [Required]
